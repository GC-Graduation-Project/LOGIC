...
def custom_predict_and_save(input_audio_path, output_directory, save_midi, sonify_midi, save_model_outputs, save_notes):
    # predict_and_save 함수 호출
    predict_and_save(
        [input_audio_path],
        output_directory,
        save_midi,
...
input_audio_path = "resources/bb.mp3"
